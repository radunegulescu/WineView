...
namespace WineView.DataAccess.Migrations
{
    ...
    [Migration("20220520132603_AddBodyAndReviewToDb2")]
    partial class AddBodyAndReviewToDb2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WineView.Models.Body", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineView.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineView.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineView.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineView.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WineView.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("WineView.Models.OrderDetail", b =>
                {
                    b.HasOne("WineView.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WineView.Models.Wine", "Wine")
                        .WithMany()
            ...
            modelBuilder.Entity("WineView.Models.OrderHeader", b =>
                {
                    b.HasOne("WineView.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WineView.Models.Review", b =>
                {
                    ...
                    b.HasOne("WineView.Models.Body", "Body")
                        .WithMany()
